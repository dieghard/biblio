<div class="modal" id="modalEmisionRecibosAbmMonto">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
      <!-- Modal HEADER-->
      <div class="modal-header">
        <h4 class="modal-title">INGRESO DE RECIBOS CON MONTO</h4>
      ...
      <div class="modal-footer">
        <button type="button" id="btnGuardarMonto" class="btn btn-success" tabindex="7">Guardar</button>
        <button type="button" id="btnCerrarAbajoMonto" class="btn btn-cancel close btn btn-warning" data-dismiss="modal" tabindex="8">Cerrar</button>
      </div>
      <div id="error"></div>
    </div>
  </div>
